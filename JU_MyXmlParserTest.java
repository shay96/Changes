...
public class JU_MyXmlParserTest {
    ...
    public void setUpClass() {
        ...
        this.testFileLiv = new File(catalogOfXmlToBePresented + "xmlTest.xml");
    }
    ...
    public void xmlParserTestLiv() {
        ...
        new XmlPresenter().presentXmlToUser(myTopLevelXmlObject);
        System.out.println(myTopLevelXmlObject.toString());
