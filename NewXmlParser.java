...
//          print line to match to double check
                ...
                if (line.contains(STARTER) && line.contains(END_SAME_LINE)) {
                    ...
                    unclosedXmlObjects.peek().addKiddies(nodeUnderConstruction);
                    ...
                    unclosedXmlObjects.peek().addKiddies(nodeUnderConstruction);
                    unclosedXmlObjects.push(nodeUnderConstruction);
                }
